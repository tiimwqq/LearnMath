			...
			<div className="container">
				<div className="header">
					...
					<div className="header__list">
						<div className="header__link">Cправочник</div>
						<div className="header__link">Таблицы</div>
						<div className="header__link">Формулы</div>
						<div className="header__link">О нас</div>
					</div>
